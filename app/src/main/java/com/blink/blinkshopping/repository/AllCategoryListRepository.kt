...
class AllCategoryListRepository @Inject constructor(private var apiService: ApiService) :
    Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<LevelcategoryListQuery.Data>>()

    fun getAllCategoryList(id: String): MutableLiveData<Resource<LevelcategoryListQuery.Data>> {
        addDisposable(

            apiService.getListCategoryData(id)!!
    ...
    fun whenSuccess(pokemon: LevelcategoryListQuery.Data) {
