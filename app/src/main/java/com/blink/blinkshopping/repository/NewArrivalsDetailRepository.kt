...
class NewArrivalsDetailRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<NewArrivalsProductsQuery.Data>>()

    fun getNewArrivalsDetail(categoryId: Int?): LiveData<Resource<NewArrivalsProductsQuery.Data>> {
        addDisposable(
            apiService.getNewArrivalsDetail(categoryId)!!
