...
class BestSellersRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<BestsellersQuery.Data>>()

    fun getBestSellersDetail(categoryId:Int?): LiveData<Resource<BestsellersQuery.Data>> {
        addDisposable(
            apiService.getBestSellersDetail(categoryId)!!
    ...
    fun whenSuccess(pokemon: BestsellersQuery.Data) {
