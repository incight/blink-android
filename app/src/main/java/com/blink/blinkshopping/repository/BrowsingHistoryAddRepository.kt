...
class BrowsingHistoryAddRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<BrowsingHistoryAddMutation.Data>>()

    fun getBrowsingHistoryAdd(id: List<Int>?): LiveData<Resource<BrowsingHistoryAddMutation.Data>> {
        addDisposable(
            apiService.getBrowsingHistoryAdd(id)!!
    ...
    fun whenSuccess(pokemon: BrowsingHistoryAddMutation.Data) {
