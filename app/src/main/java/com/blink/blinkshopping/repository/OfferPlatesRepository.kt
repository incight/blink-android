...
class OfferPlatesRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<OfferPlatesQuery.Data>>()

    fun getOfferPlatesDetail(): LiveData<Resource<OfferPlatesQuery.Data>> {
        addDisposable(
            apiService.getOfferPlatesDetail()!!
    ...
    fun whenSuccess(pokemon: OfferPlatesQuery.Data) {
