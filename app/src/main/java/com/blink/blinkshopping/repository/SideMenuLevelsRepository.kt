...
class SideMenuLevelsRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<GetMenuCategoryListQuery.Data>>()

    fun getSideMenuLayoutDetail(id:String): LiveData<Resource<GetMenuCategoryListQuery.Data>> {
        addDisposable(
            apiService.getSideMenuDetail(id)!!
