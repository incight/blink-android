...
class InspireHistoryProductsSkuByListRepository @Inject constructor(private var apiService: ApiService) : Repository {
    ...
    fun getProductsSkuDetail(sku: List<String>?): LiveData<Resource<ProductsSkuByListQuery.Data>> {
        addDisposable(
            apiService.getInspiredHistoryProductsSkuDetail(sku)!!
