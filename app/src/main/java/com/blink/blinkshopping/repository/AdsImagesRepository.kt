...
class AdsImagesRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<GetAdsimagesQuery.Data>>()

    fun getAdsImagesDetail(id: List<Int>?): LiveData<Resource<GetAdsimagesQuery.Data>> {
        addDisposable(
            apiService.getAdsImagesDetail(id)!!
    ...
    fun whenSuccess(pokemon: GetAdsimagesQuery.Data) {
