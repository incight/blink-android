...
class SendOtpRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<SendOtpMutation.Data>>()

    fun getSendOtpDetail(email: String, mobilenumber: String, type: String): LiveData<Resource<SendOtpMutation.Data>> {
        addDisposable(
            apiService.getSendOtpDetail(email,mobilenumber,type)!!
    ...
    fun whenSuccess(pokemon: SendOtpMutation.Data) {
