...
class SingleProductSkuRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<ProductsForSKUQuery.Data>>()

    fun getSingleProductSkuDetail(sku: String?): LiveData<Resource<ProductsForSKUQuery.Data>> {
        addDisposable(
            apiService.getSingleProductSkuDetail(sku)!!
    ...
    fun whenSuccess(pokemon: ProductsForSKUQuery.Data) {
