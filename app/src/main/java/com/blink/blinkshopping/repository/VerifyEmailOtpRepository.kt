...
class VerifyEmailOtpRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<ResetVerifyEmailOtpMutation.Data>>()

    fun getResetVerifyEmailOtpDetail(email: String, otp: String): LiveData<Resource<ResetVerifyEmailOtpMutation.Data>> {
        addDisposable(
            apiService.getResetVerifyEmailOtpDetail(email,otp)!!
    ...
    fun whenSuccess(pokemon: ResetVerifyEmailOtpMutation.Data) {
