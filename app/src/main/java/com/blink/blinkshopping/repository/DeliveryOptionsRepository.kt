...
import com.blink.blinkshopping.ProductDeliveryOptionsQuery
...
class DeliveryOptionsRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<ProductDeliveryOptionsQuery.Data>>()


    fun getDeliveryOptionsDetail(sku: String,qty: Int): LiveData<Resource<ProductDeliveryOptionsQuery.Data>> {
        addDisposable(
            apiService.getDeliveryOptionsDetail(sku,qty)!!
    ...
    fun whenSuccess(pokemon: ProductDeliveryOptionsQuery.Data) {
