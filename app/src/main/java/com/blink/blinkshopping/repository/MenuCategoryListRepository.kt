...
class MenuCategoryListRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<GetMenuCategoryListQuery.Data>>()

    fun getCategoryListDetail(categoryId: String?): LiveData<Resource<GetMenuCategoryListQuery.Data>> {
        addDisposable(
            apiService.getCategoryListDetail(categoryId)!!
    ...
    fun whenSuccess(pokemon: GetMenuCategoryListQuery.Data) {
