...
class StorePickupRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<StorePickupQuery.Data>>()

    fun getStorePickupDetail(sku:String,qty: Int): LiveData<Resource<StorePickupQuery.Data>> {
        addDisposable(
            apiService.getStorePickupDetail(sku,qty)!!
    ...
    fun whenSuccess(pokemon: StorePickupQuery.Data) {
