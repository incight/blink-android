...
class BrowsingHistoryGetRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<BrowsingHistoryGetQuery.Data>>()

    fun getBrowsingHistoryGet(): LiveData<Resource<BrowsingHistoryGetQuery.Data>> {
        addDisposable(
            apiService.getBrowsingHistoryGet()!!
    ...
    fun whenSuccess(pokemon: BrowsingHistoryGetQuery.Data) {
