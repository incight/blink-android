...
class BannersDetailRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<GetBannersListQuery.Data>>()

    fun getBannersDetail(id: Int): LiveData<Resource<GetBannersListQuery.Data>> {
        addDisposable(
            apiService.getBannersDetail(id)!!
    ...
    fun whenSuccess(pokemon: GetBannersListQuery.Data) {
