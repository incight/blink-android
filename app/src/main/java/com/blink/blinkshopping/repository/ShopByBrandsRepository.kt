...
class ShopByBrandsRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<ShopByBrandImageQuery.Data>>()

    fun getProductListBrandList(id: String): MutableLiveData<Resource<ShopByBrandImageQuery.Data>> {
        addDisposable(
            apiService.getShopByImageBrands(id)!!
    ...
    fun whenSuccess(data: ShopByBrandImageQuery.Data) {
