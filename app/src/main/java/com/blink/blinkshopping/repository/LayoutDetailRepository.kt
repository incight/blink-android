...
class LayoutDetailRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<HomeLayoutsQuery.Data>>()

    fun getLayoutDetail(id: String,device_type:String): LiveData<Resource<HomeLayoutsQuery.Data>> {
        addDisposable(
            apiService.getLayoutDetail(id,device_type)!!
    ...
    fun whenSuccess(pokemon: HomeLayoutsQuery.Data) {
