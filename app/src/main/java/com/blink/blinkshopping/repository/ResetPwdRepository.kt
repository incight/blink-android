...
class ResetPwdRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<ResetpasswordMutation.Data>>()

    fun getResetPwdDetails(email: String, password: String): LiveData<Resource<ResetpasswordMutation.Data>> {
        addDisposable(
                apiService.getResetPwdDetail(email,password)!!
    ...
    fun whenSuccess(pokemon: ResetpasswordMutation.Data) {
