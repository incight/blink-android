...
class RegisterUserRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<RegisterUserMutation.Data>>()

    fun getRegisterUserDetail(name: String,
                              country: Int,
                              dob: String,
                              ...
                              password: String,
                              gender: Int,
                              isSubscribe: Boolean): LiveData<Resource<RegisterUserMutation.Data>> {
        addDisposable(
            apiService.getRegisterUserDetail(name,country,dob,mobile_number,lname,email,password,gender,isSubscribe)!!
    ...
    fun whenSuccess(pokemon: RegisterUserMutation.Data) {
