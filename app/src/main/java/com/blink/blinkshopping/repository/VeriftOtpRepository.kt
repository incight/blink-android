...
class VeriftOtpRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<VerifyOtpMutation.Data>>()

    fun getVeirfyOtpDetail(email: String, mobilenOtp: String, emailOtp: String): LiveData<Resource<VerifyOtpMutation.Data>> {
        addDisposable(
            apiService.getVeirfyOtpDetail(email,mobilenOtp,emailOtp)!!
    ...
    fun whenSuccess(pokemon: VerifyOtpMutation.Data) {
