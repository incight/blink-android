...
class FrequentBroughtRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<FrequentlyBoughtTogetherQuery.Data>>()

    fun getFrequentBroughtDetail(sku:List<Int>?): LiveData<Resource<FrequentlyBoughtTogetherQuery.Data>> {
        addDisposable(
            apiService.getFrequentBroughtDetail(sku)!!
    ...
    fun whenSuccess(pokemon: FrequentlyBoughtTogetherQuery.Data) {
