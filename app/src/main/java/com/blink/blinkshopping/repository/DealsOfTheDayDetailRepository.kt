...
class DealsOfTheDayDetailRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<DailyDealsProductsQuery.Data>>()

    fun getDealsOfTheDayDetail(): LiveData<Resource<DailyDealsProductsQuery.Data>> {
        addDisposable(
            apiService.getDealsOfTheDayDetail()!!
    ...
    fun whenSuccess(pokemon: DailyDealsProductsQuery.Data) {
