...
class CompareSimilarRepository @Inject constructor(private var apiService: ApiService) : Repository {

    private val compositeDisposable = CompositeDisposable()

    private val result = MutableLiveData<Resource<CompareWithSimilarProductsQuery.Data>>()

    fun getCompareWithSimilarDetail(product:Int): LiveData<Resource<CompareWithSimilarProductsQuery.Data>> {
        addDisposable(
            apiService.getCompareWithSimilarDetail(product)!!
    ...
    fun whenSuccess(pokemon: CompareWithSimilarProductsQuery.Data) {
