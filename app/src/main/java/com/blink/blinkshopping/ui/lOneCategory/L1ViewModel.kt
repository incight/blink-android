...
class L1ViewModel @Inject constructor(
    ...
    private val productsFilterRepository: ProductsFilterRepository
) : ViewModel() {
    ...
    lateinit var ProductsQueryLiveData: LiveData<Resource<ProductsQuery.Data>>
    fun ProductsQueryCall(id: String?) {
        ProductsQueryLiveData = productsFilterRepository.getproductsFilter(id!!)
    }

    override fun onCleared() {
        productsFilterRepository.clear()
        
        browsinghistorygetrepository.clear()
        browseHistoryProductsSkuByListRepository.clear()
        browsingHistoryDeleteRepository.clear()
