package com.blink.blinkshopping.otptextview
...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        barErrorColor = styles.getColor(R.styleable.OtpTextView_bar_error_color, ResourcesCompat.getColor(context.resources, R.color.redcolor, null))
